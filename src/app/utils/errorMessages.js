module.exports = {
  user: {
    ...
    'username.min': 'O nome de usuário deve possuir no mínimo 3 caracteres',
    'username.max': 'O nome de usuário deve possuir no máximo 30 caracteres',
  ...
  film: {
    ...
    'persons.*.id.required': 'O ID da pessoa é obrigatório',
    'persons.*.role.required': 'O papel da pessoa é obrigatório',
    'persons.*.role.in': 'Papel inválido',
